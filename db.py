...
con.execute('insert into decks(name, creator) values("test1", "claresies")')
con.execute('insert into decks(name, creator) values("test2", "claresies")')
con.execute('insert into decks(name, creator) values("test3", "claresies")')
